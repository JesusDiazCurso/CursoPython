...
def mostrar_table_widget():
    ...
    for l in juegos:
        ...
        ui_ventana_table_widget.tabla_juegos.setCellWidget(fila,7,boton_editar)
...
def editar_juego(id,juego):
    ...
    ui_ventana_editar_juegos.entrada_nombre_juego.setText(str(juego_a_editar.nombrejuego))
    ui_ventana_editar_juegos.entrada_tipo_plataforma.setText(str(juego_a_editar.plataforma))
