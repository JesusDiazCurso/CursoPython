...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(230, 100, 421, 111))
        font = QtGui.QFont()
        ...
        self.menuMusica.addAction(self.submenu_inicio)
        self.menuMusica.addAction(self.submenu_insertar_juego)
        self.menuMusica.addAction(self.submenu_listar_juegos)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuMusica.setTitle(_translate("MainWindow", "VideoJuegos"))
